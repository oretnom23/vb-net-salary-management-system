...
Public Class EmployeeDetails
    ...
    Private Sub EmployeeDetails_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
            Me.Dispose()
            FrmMain.Show()
    ...
    Private Sub Save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Try
            ...
            End If
            con.Open()
            Dim ct As String = "select EmpID from PGStaffEmpDetails where EmpID=@find"
            ...
            Else
                ...
                Dim cb As String = "insert into PGStaffEmpDetails(EmpID,EmpName,Designation,BSalary,AGP,Address,City,State,zipcode,MobileNo,EmailID,Notes) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9,@d10,@d11,@d12)"
                ...
                cmd.Parameters.Add(New SqlParameter("@d5", System.Data.SqlDbType.VarChar, 10, "AGP"))

                cmd.Parameters.Add(New SqlParameter("@d6", System.Data.SqlDbType.VarChar, 100, "Address"))

                cmd.Parameters.Add(New SqlParameter("@d7", System.Data.SqlDbType.VarChar, 50, "City"))

                cmd.Parameters.Add(New SqlParameter("@d8", System.Data.SqlDbType.VarChar, 50, "State"))

                cmd.Parameters.Add(New SqlParameter("@d9", System.Data.SqlDbType.VarChar, 15, "zipcode"))

                cmd.Parameters.Add(New SqlParameter("@d10", System.Data.SqlDbType.VarChar, 15, "MobileNo"))

                cmd.Parameters.Add(New SqlParameter("@d11", System.Data.SqlDbType.VarChar, 100, "EmailID"))

                cmd.Parameters.Add(New SqlParameter("@d12", System.Data.SqlDbType.VarChar, 250, "Notes"))
                ...
                cmd.Parameters("@d5").Value = txtAGP.Text

                cmd.Parameters("@d6").Value = txtAddress.Text

                cmd.Parameters("@d7").Value = txtCity.Text

                cmd.Parameters("@d8").Value = cmbState.Text

                cmd.Parameters("@d9").Value = txtZipCode.Text

                cmd.Parameters("@d10").Value = txtMobileNo.Text

                cmd.Parameters("@d11").Value = txtEmail.Text

                cmd.Parameters("@d12").Value = txtNotes.Text
    ...
    Private Sub Update_record_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Update_record.Click
        Try
            ...
            Dim cb As String = "update PGStaffEmpDetails set Empname=@d2,Designation=@d3,BSalary=@d4,AGP=@d5,Address=@d6,City=@d7,State=@d8,zipcode=@d9,MobileNo=@d10,EmailID=@d11,Notes=@d12 where EmpID='" & txtEmpID.Text & "'"
            cmd = New SqlCommand(cb)
            cmd.Connection = con
    ...
    Private Sub delete_records()
        Try
            ...
            Dim cq As String = "delete from PGStaffEmpDetails where EmpID=@DELETE1;"
