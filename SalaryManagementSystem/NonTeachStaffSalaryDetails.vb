...
Public Class NonTeachStaffSalaryDetails
    ...
    Private Sub NonTeachStaffSalaryDetails_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
            OleCn.Close()
            Me.Dispose()
    ...
    Private Sub NonTeachStaffSalaryDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Call fillEmpName()
            Call fillSalaryCode()
        Catch ex As Exception
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        ...
        Try
            ...
            FrmNonTeachStaffSalaryDetails.txtSalaryCode.Text = dr.Cells(0).Value.ToString()
            FrmNonTeachStaffSalaryDetails.Show()
            Me.Dispose()
