...
Public Class FrmPGStaffSalaryDetails
    ...
    Private Sub FrmPGStaffSalaryDetails_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
            OleCn.Close()
            Me.Dispose()
    ...
    Private Sub FrmPGStaffSalaryDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Call fillSalaryCode()
            Call fillEmpName()
        Catch ex As Exception
    ...
    Private Sub DataGridView2_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView2.RowHeaderMouseClick
        ...
        Try
            ...
            EmployeeSalaryDetails.TxtSalaryCode.Text = dr.Cells(0).Value.ToString()
            EmployeeSalaryDetails.Show()
            Me.Dispose()
