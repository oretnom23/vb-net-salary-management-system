...
Public Class FrmNonTeachStaffSalaryReport
    ...
    Sub fillEmpName()
        Try
            ...
            adp.SelectCommand = New SqlCommand("SELECT distinct  (EmpName) FROM DetailNonTechingStaff", CN)
            ds = New DataSet("ds")
    ...
    Private Sub FrmNonTeachStaffSalaryReport_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
            Me.Dispose()
            OleCn.Close()
            FrmMain.Show()
    ...
    Private Sub FrmNonTeachStaffSalaryReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            cryRpt.Load(My.Application.Info.DirectoryPath & "\Reports\Report2.rpt")
            ...
            QueryString = "SELECT NonTeachSalaryCode,SalaryDT1,SalaryDT2,SlNo, EmpID, EmpName, Designation,GrossSalary,PF,ProfTax,TotDeduction,NetSalary, MGMPF FROM DetailNonTechingStaff where SalaryDT1 like @Code and SalaryDT2 like @Code2"
            ...
            Adapter.Fill(ds, "DetailNonTechingStaff")
    ...
    Private Sub PButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PButton2.Click
        ...
        Try
            ...
            QueryString = "SELECT SlNo, EmpID, EmpName, Designation,GrossSalary,PF,ProfTax,TotDeduction,NetSalary, MGMPF FROM DetailNonTechingStaff where EmpName like @Code"
    ...
    Private Sub PButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PButton1.Click
        ...
        Try
            ...
            QueryString = "SELECT NonTeachSalaryCode,SalaryDT1,SalaryDT2,SlNo, EmpID, EmpName, Designation,GrossSalary,PF,ProfTax,TotDeduction,NetSalary, MGMPF FROM DetailNonTechingStaff where NonTeachSalaryCode like @Code"
